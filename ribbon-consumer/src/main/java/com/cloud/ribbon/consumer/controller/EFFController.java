...
//import com.cloud.ribbon.consumer.service.EFFService;
...
//    @Autowired
//    private EFFService effService;
//   /* public Map selectId(String usrid){
//        return effService.selectId(usrid);
...
//    //@ResponseBody
//    //@GetMapping("/selectId")
//    public Map<String, Object> selectId(String usrid) {
//        EADataBaseUtil db = new EADataBaseUtil();
//        Map<String, Object> map = new HashMap<String, Object>();
//        String sql = "";
//        try {
